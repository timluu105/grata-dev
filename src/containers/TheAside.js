		...
		>
			...
			<CTabs>
				<CNav variant="tabs" className="nav-underline nav-underline-primary">
					<CNavItem>
						<CNavLink>
							<CIcon content={freeSet.cilList} alt="CoreUI Icons List" />
						</CNavLink>
					</CNavItem>
					<CNavItem>
						<CNavLink>
							<CIcon content={freeSet.cilSpeech} alt="CoreUI Icons Speech" />
						</CNavLink>
					</CNavItem>
					<CNavItem>
						<CNavLink>
						...
						<CListGroup accent>
							...
							>
								...
								<small className="text-muted mr-3">
									<CIcon content={freeSet.cilCalendar} /> 1 - 3pm
								</small>
								<small className="text-muted">
									<CIcon content={freeSet.cilLocationPin} /> Palo Alto, CA
								</small>
							</CListGroupItem>
							<CListGroupItem accent="info" href="#">
								...
								<small className="text-muted mr-3">
									<CIcon content={freeSet.cilCalendar} /> 4 - 5pm
								</small>
								<small className="text-muted">
									<CIcon content={freeSet.cibSkype} /> On-line
								</small>
							</CListGroupItem>
							...
							>
								...
								<small className="text-muted mr-3">
									<CIcon content={freeSet.cilCalendar} /> 10 - 11pm
								</small>
								<small className="text-muted">
									<CIcon content={freeSet.cilHome} /> creativeLabs HQ
								</small>
							...
							>
								...
								<small className="text-muted mr-3">
									<CIcon content={freeSet.cilCalendar} /> 4 - 6pm
								</small>
								<small className="text-muted">
									<CIcon content={freeSet.cilHome} /> creativeLabs HQ
								</small>
